...
//                            Log.e("TAG", attrs.getAttributeName(i) + " , " + attrs.getAttributeValue(i));
     ...
     * @return 属性id
     */
    private static int getAttr(Class draw, String attrName) {
     ...
     * @param style 切换style
     */
    private static void changeNight(Activity ctx, int style) {
     ...
     * @param style 切换style
     */
    private static void changeDay(Activity ctx, int style) {
        if (mBackGroundDrawableViews == null
                || mOneTextColorViews == null
